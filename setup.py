...
setup(
    ...
    keywords='cloudconvert video converter linkgenerator',
    project_urls={
    ...
    description="Online Video Converter via cloudconvert.com",
